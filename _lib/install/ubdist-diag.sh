...
#export ssh="" ; wget -qO- https://raw.githubusercontent.com/soaringDistributions/ubDistBuild/main/_lib/install/ubdist-diag.sh | bash

#export ssh="" ; export GH_TOKEN="" ; export owner="" ; export repo="" ; export INPUT_GITHUB_TOKEN="$GH_TOKEN" ; wget -qO- https://raw.githubusercontent.com/soaringDistributions/ubDistBuild/main/_lib/install/ubdist-diag.sh | bash
...
# ATTENTION: NOTICE: This is the difference between 'ubdist.sh' and 'ubdist-diag.sh' .
##export FORCE_AXEL=8
